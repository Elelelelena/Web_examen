...
<body>
    ...
    <div class="container">
        ...
        <form class="form_align" method="POST" action="profile.php" enctype="multipart/form-data" name="upload">
                <input type="text" class="form" type="text" name="title" placeholder="Заголовок вашего поста"></div>
                <textarea name="text" class="form_width" rows="10" placeholder="Введите текст вашего поста....."></textarea>
                <input type="file" name="file" /><br>
                <button type="submit" class="btn_red" id="save-post-button" name="submit">Сохранить пост!</button>
            </form>
        </div>
    </div>
</div>
